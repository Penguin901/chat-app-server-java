# Chat Application Server Java
  
채팅 시스템의 서버로 Flutter 앱과 통신하며, REST API와 WebSocket 기반의 실시간 채팅 기능을 제공합니다.
프로젝트 초기에 구현했던 버전으로, 백엔드 애플리케이션의 전반적인 동작 이해를 목표로 합니다.
...
<details>
<summary>보기</summary>
<img width="605" height="481" alt="Screenshot 2026-06-02 at 11 00 13 PM" src="https://github.com/user-attachments/assets/93793a4e-4047-4e5a-b245-b19093100565" />
</details>
